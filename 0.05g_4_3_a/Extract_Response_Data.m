...
fr_0p05_f = table2array(T(:,1));
V_0p05_f  = table2array(T(:,4));
clear T
T = readtable('Sx_SVC01_sv005.csv','NumHeaderLines',9);
fr_0p05_b = table2array(T(:,1));
V_0p05_b  = table2array(T(:,4));
clear T 
cd ..
end
...
figure(3)
plot(fr_0p05_f,V_0p05_f/1000,'o','MarkerEdgeColor',color1,'MarkerSize',10,'MarkerFaceColor',color1,'MarkerIndices', [1:15:length(V_0p05_f)])
hold on
plot(fr_0p05_b,V_0p05_b/1000,'o','MarkerEdgeColor',color2,'MarkerSize',10,'MarkerFaceColor',color2,'MarkerIndices', [1:15:length(V_0p05_b)])
set(gca,'FontSize',28)
...
text(6.2,1,'$a_b=0.05~g$','Interpreter','latex','FontName','Times New Roman','FontSize',32)
ylim([0 1.4])
% 
% figure(2)
