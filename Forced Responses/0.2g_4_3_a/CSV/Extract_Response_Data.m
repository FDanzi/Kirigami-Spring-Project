...
fr_0p2_f = table2array(T(:,1));
V_0p2_f  = table2array(T(:,4));
clear T
T = readtable('Sx_SVC01_sv004.csv','NumHeaderLines',9);
fr_0p2_b = table2array(T(:,1));
V_0p2_b  = table2array(T(:,4));
clear T 
cd ..
end
...
figure(3)
plot(fr_0p2_f,V_0p2_f/1000,'o','MarkerEdgeColor',color1,'MarkerSize',10,'MarkerFaceColor',color1,'MarkerIndices', [1:15:length(V_0p2_f)])
hold on
plot(fr_0p2_b,V_0p2_b/1000,'o','MarkerEdgeColor',color2,'MarkerSize',10,'MarkerFaceColor',color2,'MarkerIndices', [1:15:length(V_0p2_b)])
set(gca,'FontSize',28)
...
text(6.2,1,'$a_b=0.2~g$','Interpreter','latex','FontName','Times New Roman','FontSize',32)
ylim([0 1.4])
% 
% figure(2)
